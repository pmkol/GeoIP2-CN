...
本项目参考[soffchen/GeoIP2-CN](https://github.com/soffchen/GeoIP2-CN)，将ipv4数据源更换为[misakaio/chnroutes2](https://github.com/misakaio/chnroutes2)，将ipv6数据源更换为[clang](https://ispip.clang.cn/all_cn_ipv6.txt)，每天更新一次。
